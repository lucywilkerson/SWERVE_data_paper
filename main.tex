...
The data collected from NERC includes GIC monitor and ground magnetometer data at NERC sites for 20 storms over North America. The selected storms include all storms through June 2025 listed on NERC ERO portal. These storms were selected both for their intensity and recency (earlier listed storms had considerably less sites available). %am currently adding more NERC storms, so this statement is not exactly true
